...
| ------------------------------------------------- | ------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| built, no data yet (**day zero**)                 | the offer over the page's own shape, dimmed and `inert`            | `home/day-zero-home.tsx`, `matches/matches-day-zero.tsx`, `schedule/static/schedule-day-zero.tsx`, `team/roster-day-zero.tsx`; `team/player-profile/profile-day-zero.tsx` is the one day zero with **no offer** — the identity row is already the page's heading and holds its primary, so it draws one sentence and the graded tail alone |
