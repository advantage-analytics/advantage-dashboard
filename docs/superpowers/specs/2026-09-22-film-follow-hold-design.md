...
| Shell point list (`PointList tone="light"`) | The open well (none today: the shell passes no `onSelectShot`); the list's scroll position (keep-in-view off while held). Same hold sources as the drawer (T24, 2026-09-23) | The lit row                                                                                                                                                                                                 |
