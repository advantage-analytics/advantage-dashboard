...
| The return affordance (pill / header line)                                                                                 | Drawer, card       | `follow`. The list scrolls smoothly to the playing row and its well unfolds; the card swaps to the playing point                                                                                             |
