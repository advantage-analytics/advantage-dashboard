...
At the top of the `## Architecture` section, before `### Route Structure`:
...
In the `### Supabase` section, replace the sentence `Schema reference: `DATABASE_PRD.md` at repo root.` with:
