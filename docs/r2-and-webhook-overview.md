...
|---|---|---|
| Wizard presentation | `new-match-wizard/{ConfirmContent,DetailsContent,SourceStepContent,ScoreCell,StepIndicator,UploadContent,VideoMetaFields,VideoStepContent,styles}.tsx` | **Yes, freely** |
