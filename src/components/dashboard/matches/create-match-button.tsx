...
const variantStyles = {
  dark: "h-9 pl-3.5 pr-4 gap-1.5 bg-[var(--surface-dark)] hover:bg-[var(--surface-dark-hover)] active:bg-[var(--surface-dark-pressed)] text-[13px] font-medium tracking-[0.5px] shadow-[0_1px_3px_rgba(0,0,0,0.2)] active:scale-[0.97]",
