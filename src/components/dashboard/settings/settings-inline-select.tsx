  ...
  return (
    <div
      className={cn(
        ...
        // The `<select>` below is opacity-0, so the ring focus.css gives it is
        // invisible — this box has to carry the indicator itself, in the same
        // neutral field treatment a visible field would get.
