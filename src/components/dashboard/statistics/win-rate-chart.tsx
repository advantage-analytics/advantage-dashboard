  ...
  return (
    <div className="bg-white border border-[rgba(0,0,0,0.08)] rounded-xl px-3 py-2.5 shadow-[0_4px_16px_rgba(0,0,0,0.1)]">
      ...
      <p className="text-xs text-[#999999]">
        Win rate:{" "}
        <span className="font-semibold text-[#3986F3]">{d.winRate}%</span>
      </p>
      <p className="text-xs text-[#999999]">
        {d.wins}W – {d.losses}L
      </p>
    ...
    <div className="bg-white border border-[rgba(0,0,0,0.06)] rounded-2xl p-6 shadow-[0_2px_8px_rgba(0,0,0,0.06)]">
      <div className="flex items-start justify-between mb-5">
        <div>
          ...
          <p className="text-xs text-[#999999] mt-0.5">Last 12 months</p>
        </div>
        {hasData && (
          <span className="text-xs font-medium text-[#3986F3] bg-[#EBF0FE] px-2 py-0.5 rounded-full">
          ...
          <AreaChart data={data} margin={{ top: 4, right: 4, bottom: 0, left: -16 }}>
            <defs>
              <linearGradient id="winRateGradient" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor="#3986F3" stopOpacity={0.15} />
                <stop offset="95%" stopColor="#3986F3" stopOpacity={0} />
              </linearGradient>
            </defs>
            ...
            />
            <Tooltip content={<CustomTooltip />} cursor={{ stroke: "#3986F3", strokeWidth: 1, strokeDasharray: "4 4" }} />
            <Area
              type="monotone"
              dataKey="winRate"
              stroke="#3986F3"
              ...
              dot={<Dot r={3} fill="#3986F3" stroke="#fff" strokeWidth={1.5} />}
              activeDot={{ r: 5, fill: "#3986F3", stroke: "#fff", strokeWidth: 2 }}
            />
          </AreaChart>
        </ResponsiveContainer>
      )}
