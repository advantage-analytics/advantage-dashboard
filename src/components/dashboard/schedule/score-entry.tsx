...
function SetCell({
  ...
  return (
    <input
      ...
      className="tabular h-[30px] w-[26px] rounded-[6px] border border-[#EAECF0] bg-white text-center text-[13px] text-[#0D0D0D] outline-none placeholder:text-[#CCCCCC] focus-visible:border-[#E5E5E5]"
    />
  );
}
...
function TiebreakCell({
  ...
  return (
    <input
      ...
      onChange={(event) => onChange(event.target.value.replace(/[^0-9]/g, ""))}
      className="tabular h-[30px] w-[26px] rounded-[6px] border border-[#EAECF0] bg-white text-center text-[11px] text-[#525252] outline-none focus-visible:border-[#E5E5E5]"
    />
  );
}
