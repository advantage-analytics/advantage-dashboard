...
/**
 * `sm` is the Form Ticks size the drawer draws. `md` is the event page's
 * summary strip (`Main.dc.html`'s Lines cell: 4×16px, 3px apart, a 5px break).
 * `lg` is the same strip at twice `sm`, for the retired score band.
 */
const SIZES = {
