 ...
 *
 * `actions` is left open on purpose: the ⋯ Merge / Delete menu lands there.
 *
    ...
    >
      <div className="flex min-h-0 flex-1 flex-col gap-6 overflow-y-auto px-[22px] pt-6 pb-[22px]">
        ...
        <div className="flex items-center gap-3.5">
          <ConferenceMark name={row.name} shortName={row.shortName} size={40} />
        ...
        >
          <Field label="Name" htmlFor="conference-name" className="col-span-2">
            <input
              id="conference-name"
              type="text"
              value={draft.name ?? ""}
