...
export default function OverallPerformance() {
  ...
  return (
    <div className="bg-white border-[#D9D9D9] border-2 p-6 rounded-2xl h-[726px] flex flex-col">
      {/* Heading */}
      <div className="flex flex-row justify-between items-center mb-6">
        <div className="space-y-2">
          <p className="font-normal text-xl text-[#0D0D0D]">Overall Performance</p>
          <p className="font-normal text-sm text-[#999999]">Your Recent Performance</p>
        </div>
      ...
      <div className="mb-8">
        <p className="font-normal text-lg text-[#0D0D0D] mb-4">Performance Rating</p>
        <div className="space-y-4">
          <PerformanceRating label="Serve" value={serveRating} barColor="#666666" />
          <PerformanceRating label="Return" value={returnRating} barColor="#4A90E2" />
          <PerformanceRating label="Serve" value={netRating} barColor="#666666" />
        </div>
      </div>
      
      {/* Recent Performance Section */}
      <div>
        <p className="font-normal text-lg text-[#0D0D0D] mb-4">Recent Performance</p>
